...
void setup()
{
  ...
  stepper2.setMaxSpeed(10000.0); //推荐30000
  stepper2.setAcceleration(30000.0); //推荐30000
  
  stepper3.setMaxSpeed(10000.0); //推荐30000
  stepper3.setAcceleration(30000.0); //推荐30000

  stepper4.setMaxSpeed(10000.0); //推荐30000
  stepper4.setAcceleration(30000.0); //推荐30000

  stepper5.setMaxSpeed(10000.0); //推荐30000
  stepper5.setAcceleration(30000.0); //推荐30000
 
  stepper6.setMaxSpeed(10000.0); //推荐30000
...
//**********************  机械臂暂停  ***********************
  if((char)inChar == 'B'){  
    ...
    if((char)inChar == 'R'){  
      ...
      if(stepper2.currentPosition()!=32){
        stepper2.runToNewPosition(5400);
    ...
    if((char)inChar == 'Z'){ //自检
     Serial.println("自检");  
     stepper1.runToNewPosition(15800);
     stepper1.runToNewPosition(-3000);
     stepper1.runToNewPosition(6400);
     stepper2.runToNewPosition(5400);
     stepper3.runToNewPosition(14732);
     stepper3.runToNewPosition(32);
     stepper2.runToNewPosition(32);
     delay(10);
    }
